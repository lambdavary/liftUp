#ifndef __imagedetector_sfun_h__
#define __imagedetector_sfun_h__
...
extern mxArray* load_imagedetector_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_imagedetector_optimization_info(void);
